...
/**
 * Access controller for the metadata entity. Controls create/edit/delete access
 * for entity and fields.
 *
 * @see \Drupal\metadata\Entity\Metadata.
 */
class MetadataAccessControlHandler extends EntityAccessControlHandler {
      ...
      switch ($operation) {
         case 'view':
            ...
            if ($entity->get('moderation_state')->getString() == 'draft') {
               if ($account->hasPermission('administer own metadatas')) {
   ...
   protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
      return AccessResult::allowedIfHasPermission($account, 'administer own metadatas');
   }
}